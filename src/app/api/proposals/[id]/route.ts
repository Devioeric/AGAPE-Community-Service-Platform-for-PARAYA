...
export async function GET(_req: Request, { params }: Ctx) {
  ...
  // Read access is capability-gated to the operational PARAYA/Finance proposal
  // DTO. Historical institutional accounts use the separate summary adapter.
