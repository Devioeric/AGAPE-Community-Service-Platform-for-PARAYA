...
export function phase2BrowserGateContract() {
  return { schema: "agape.phase2-browser-gates.v1", cases: 9, aiRequests: 3, finalState: { phase2Modes: "off", recommendationAutomation: "off", partnerMutationAuthority: "v1", proposalMutationAuthority: "v1" } };
}
...
export async function runPhase2BrowserGates({ root, apiUrl, anonKey, serviceRoleKey, readWorkflowFingerprint, expectedPort = 54321 }) {
  ...
  const scenarios = [
    ...
    { name: "recommendation_settings", modes: [], flags: {} },
