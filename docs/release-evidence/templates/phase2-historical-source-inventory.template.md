# Historical Source Inventory evidence template
...
Operator: Full Name (<PARAYA Researcher|PARAYA Associate>)
Reviewer: Different Full Name (<PARAYA Director|Research Reviewer>)
...
Suite-ID: agape.phase2.historical-source-inventory.v1
Suite-Version: 1.0.0
