...
export default function BarangaySurveysPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-heading text-lg font-semibold text-foreground">Available Surveys</h2>
        <p className="text-sm text-muted-foreground mt-0.5">Complete surveys assigned by PARAYA officers to help with community planning.</p>
      </div>
              ...
              <Card key={s.id} className="border-border shadow-card hover:shadow-md transition-shadow">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {done
                      ? <Badge className="bg-success/10 text-success border-success/20 border text-xs">Completed</Badge>
                ...
                <CardContent className="pt-0 space-y-3">
                  ...
                  <Button
                    ...
                    disabled={done}
                    className={`w-full ${done ? "bg-muted text-muted-foreground" : "bg-primary hover:bg-primary-dark text-white"}`}
                  >
                    {done ? <><CheckCircle className="w-4 h-4 mr-2" /> Submitted</> : "Answer Survey"}
                  </Button>
                </CardContent>
              </Card>
            );
