...
| D — Canonical baseline | in_progress | The validated empty ledger selects Branch 1: derive the pre-Phase-0 baseline from the exact authoritative staging schema. The private 763-object matrix records 600 live-only, 149 definition-drift, 8 repository-only, and 6 order-unknown rows; no object required guessed baseline placement. Baseline promotion/replay has not occurred. | Packet 8 constructs and replays the private candidate, then requires a distinct database/security reviewer before promotion and archive. |
...
| 7 — Authoritative reconciliation and baseline branch | locally_complete | Validated private capture `AGAPE-STAGING-20260825-PACKET7` against PostgreSQL 17: schema hash `e914ebeba42b1bc3b68c1d26a211aa737569c7ac62f81ad2d2240af7dafcd6c9`, zero timestamped ledger versions, 58 public tables, 4 extensions, 3 Storage buckets, and 12 Storage policy/RLS entries. Branch 1 is selected. The hash-only 763-object reconciliation matrix has digest `cb95a4bb1d40601830b898f8c7708e83339f58f77c31dfb3f1da9bfa7db364e3`; legacy conflicts are retained as `Order unknown`, not silently resolved. No baseline or migration was written/applied. | Begin Packet 8 candidate replay locally. A distinct reviewer is mandatory before baseline promotion/archive or any ledger proposal approval. |
...
- Results: authoritative capture validation passed; PostgreSQL major is 17; ledger contains zero timestamped versions; baseline Branch 1 is selected. The public schema hash is `e914ebeba42b1bc3b68c1d26a211aa737569c7ac62f81ad2d2240af7dafcd6c9`. The 763-object matrix digest is `cb95a4bb1d40601830b898f8c7708e83339f58f77c31dfb3f1da9bfa7db364e3`. Full static verification passed 147 tests with zero failures/skips, typecheck, lint, and the 155-route build. Docker-aware preflight exits 1 only for the intentionally unpromoted baseline, 53 active unordered files, and the Phase 2 scope’s missing baseline; it attempted no database operation.
