# Component Authorizations evidence template
...
Operator: Full Name (<Phase 2 Test Owner>)
...
Suite-ID: agape.phase2.component-authorizations.v1
Suite-Version: 1.0.0
Passed-Cases: <integer-at-least-1>
Failed-Cases: 0
Skipped-Cases: 0
Partner-Registry-Final-Mode: off
Historical-Programs-Final-Mode: off
Structured-Proposals-Final-Mode: off
Program-Finance-Final-Mode: off
