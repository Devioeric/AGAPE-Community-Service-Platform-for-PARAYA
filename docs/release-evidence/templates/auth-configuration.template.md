# Auth Configuration evidence template
...
Operator: Full Name (<Auth Administrator>)
Reviewer: Different Full Name (<Security Reviewer|QA Reviewer>)
...
Suite-ID: agape.phase1.auth-configuration.v1
Suite-Version: 1.0.0
